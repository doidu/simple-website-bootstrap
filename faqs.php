...
<body class="d-flex flex-column h-100">
	<div>
		<div class="container">
			...
			<div class="row mx-1">
				<div class="col">
					<h2 class="courier-prime-bold">FAQs</h2>
					<div class="border p-4 mt-3 me-5" style="--bs-border-color: #4E524C;">
						<div class="" style="  display: block; margin-left: auto; margin-right: auto; width: 75%;">
							<img src="faqs.png" style="  display: block; width: 100%; height: 100%;">
						</div>
					</div>
